@extends('layouts.default') <!-- When this page loads, it loads layout, layout then loads the content section below-->
        ...
        <ul class="slides-container">
            <li class="text-left">
                ...
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <h1 class="m-b-20"><strong>Welcome To <br> ZerShop</strong></h1>
